...
vcf_filename = "ALL.chr15.phase1_release_v3.20101123.snps_indels_svs.genotypes.vcf.gz"
...
with open(panel_filename) as panel_file:
    labels = {} # dicitionary {sample_id: population_code}
...
df.to_csv("matrix_transpozed.csv")
